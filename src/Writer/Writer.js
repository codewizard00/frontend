        ...
        <div className="mt-20">
            ...
            <div className="xl:px-20 px-8 py-20 2xl:mx-auto 2xl:container relative z-40">
                <CarouselProvider naturalSlideWidth={100} isIntrinsicHeight={true} totalSlides={2}>
                    <h1 className="text-5xl font-[kalam] font-bold xl:block hidden leading-tight text-gray-800">
                        आज का रचनाकार
                    </h1>
                    <h1 className="text-5xl font-[kalam] font-bold xl:hidden block leading-tight lg:leading-10 text-gray-800">आज का रचनाकार</h1>
