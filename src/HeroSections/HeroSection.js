                ...
                <section className="max-w-screen-xl mx-auto dark:bg-gray-800 dark:text-gray-100 bg-gray-100">
                    <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
                        <div className={`flex ${left?"":"order-last"} flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left`}>
                            <h1 className="text-2xl font-bold leading-none lg:text-left sm:text-4xl">Special Tribute to Kabir Das
                            </h1>
                            ...
                            <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
                                <a rel="noopener noreferrer" href="#" className="px-8 py-3 border-2 border-solid border-navy rounded-lg  text-lg decoration-none no-underline hover:text-gray-100 hover:bg-navy font-semibold rounded dark:bg-violet-400 dark:text-gray-900">Know More</a>
                            </div>
                        </div>
