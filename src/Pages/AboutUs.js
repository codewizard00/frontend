    ...
    return (
        <>
            ...
            <section class="max-w-5xl mx-auto py-10">
                <div>
                    <h1 className="text-3xl my-10 text-center md:text-4xl ">
                        हमारे बारे में
                    </h1>
                    <div class="flex flex-row w-[92%] mx-auto md:w-full">
                    ...
                    <div class="flex flex-row-reverse w-[92%] md:w-full mx-auto">
                        <div class="flex-auto border rounded  border-gray-300">
                            <div class="flex md:flex-row flex-col items-center">
                                <div class="flex-auto">
